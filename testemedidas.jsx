function theScript() {
    ...
    // Solicita que um documento já esteja aberto
    try {
        if (app.documents.length > 0 ) {
            
            // Caso esteja OK, prossiga com a configuração
            
         var args = {};   
             args.SCRIPT_NAME = "MEDIDAS";
         ...
         main(args);
            ...
            throw new Error('Não há documentos abertos!');
        }
    }
    catch(e) {
        alert( e.message, "Alerta de Script", true);
    }
    ...
    function sfDialogFactory(dialog) {
      ...
      var bOK = buttonGroup.add("button", undefined, "Continuar"); 
      var bCANCEL = buttonGroup.add("button", undefined, "Cancelar");
    ...
    // Main Dialog
      ...
      dialogObj.title = "Medidas";
    
      var group1 = {};
      group1.title = "Pegar Medidas";
      ...
      group1.elements = [
        {
            ...
            "type":"statictext",
            "value":"Medir o objeto selecionado?",
            "visible":true        
        },
        {
            "name":"Selected",        
            "type":"statictext",
            "value":"Selecionado: " + selectionName,
            "visible":true
        },
        {
        ...
        },
        {
            "name":"UnitType",           
            "type":"dropdownlist",
            "value":["polegadas","pontos","milímetros","centímetros", "pixels"], 
            "visible":true,        
            "selection":0,         
        ...
        },
        {
            ...
            "type":"statictext",
            "value":"Cor das Linhas de Medidas",
            "visible":true
        },
        {
            "name":"ColorType",            
            "type":"dropdownlist",
            "value":["MAGENTA","CIANO","VERMELHO","BRANCO","PRETO"], 
            "visible":true,        
            "selection":0,         
            // "onChange":function(){ alert("My Drop Downdown change"); return true;}
        },
        ...
        },
        {
            "name":"MarkerOffset",         
            "type":"statictext",
            "value":"Distância das marcas de medidas",
            "visible":true
        },
        {
      ...
      dialogObj.callback = function(type, formData) {
        if (type === "continue"){
          ...
          takeMeasurement(args.DOC_REF, unit, color, colorMode, markerOffset);
        }
        else {
          // Cancel
          return false;
    ...
    function takeMeasurement(doc_ref, unit, colorName, colorMode, markerOffset) {
        ...
        if (selectedItem) {
            ...
            alert("Você deve selecionar um item antes de obter suas medidas.");        
            return false;        
        }
        ...
        function makeDimensions(doc_ref, objBounds, context, measurementColor, lineOffset) {
            ...
            var measurementLayerName = "MEDIDA DE ";
